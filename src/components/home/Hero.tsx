...
export default function Hero() {
  return (
    <section className="relative min-h-[95vh] flex items-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-8 py-24 grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-16 items-center">
        {/* Left Content */}
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-12 animate-fade-up" style={{ animationDelay: "0.3s" }}>
            <Link
              href="/#free-sample"
              className="group inline-flex items-center gap-2 px-8 py-4 rounded-2xl text-white font-black text-base shadow-xl shadow-brand-purple/20 hover:shadow-brand-purple/40 hover:-translate-y-1 transition-all duration-300 tracking-tight"
              style={{ 
