          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-brand-purple/20 hover:border-brand-purple/30 transition-all"
                aria-label="LinkedIn"
              >
